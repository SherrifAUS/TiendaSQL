...
Repositorio con la estructura relacional, restricciones de integridad y poblamiento transaccional para la base de datos del proyecto.
...
- **Evolución y mantenimiento**: Modificación focalizada de valoración de catálogo (`UPDATE` con filtro por rango de precio) y depuración de datos (`DELETE` de registro de prueba mediante condición `WHERE` con subconsulta).
